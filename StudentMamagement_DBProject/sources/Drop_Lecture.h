// Drop_Lecture.h : Declaration of the CDrop_Lecture

#pragma once

// code generated on 2014년 6월 20일 금요일, 오전 11:05
// 100835 한승환
class CDrop_LectureAccessor
{
public:
...
// store the password in some other form or use a different user authentication.
	...
	DEFINE_COMMAND_EX(CDrop_LectureAccessor, L"{ ? = CALL dbo.Drop_Lecture(?,?) }")		// Stored Procedure


	BEGIN_PARAM_MAP(CDrop_LectureAccessor)
...
template <class T>
class CDrop_Lecture : public CCommand<CAccessor<T>, CNoRowset >
{
public:
	HRESULT OpenAll()
	{
