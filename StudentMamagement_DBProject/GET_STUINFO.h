// GET_STUINFO.h : Declaration of the CGET_STUINFO

#pragma once

// code generated on 2014년 6월 20일 금요일, 오후 9:46
// 100835 한승환
class CGET_STUINFOAccessor
{
public:
...
// store the password in some other form or use a different user authentication.
	...
	DEFINE_COMMA-ND_EX(CGET_STUINFOAccessor, L"{ ? = CALL dbo.GET_STUINFO(?,?,?,?) }")		// Stored Procedure


	BEGIN_PARAM_MAP(CGET_STUINFOAccessor)
		...
		SET_PARAM_TYPE(DBPARAMIO_INPUT | DBPARAMIO_OUTPUT)
		COLUMN_ENTRY(4, m_Phone_Number)
		SET_PARAM_TYPE(DBPARAMIO_INPUT | DBPARAMIO_OUTPUT)
		COLUMN_ENTRY(5, m_ADDRESS)
	END_PARAM_MAP()
};
template <class T>
class CGET_STUINFO : public CCommand<CAccessor<T>, CNoRowset >
{
public:
	HRESULT OpenAll()
	{
