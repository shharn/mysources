...
public class StaticTypeCheck {
    ...
    public static void V (Expression e, TypeMap tm) {
        ...
        if ( e instanceof Unary){	// -, !, char, float, int
        	Unary u = (Unary)e;
        	if(u.op.NegateOp()){
        		V(u.term, tm);
        		return;
    ...
    public static void V (Statement s, TypeMap tm) {
        ...
        if ( s instanceof Loop){	// Loop -> Expression test, Statement body
        	Loop l = (Loop)s;
        	V(l.test, tm);
        	V(l.body, tm);
        	return;
        }
        if ( s instanceof Conditional){	// Conditional -> Expression test, Statement thenbranch, elsebranch
        ...
        if( s instanceof Block){
        	for(Statement each_item : ((Block)s).members)
        		V(each_item, tm);
        	return;
        }
        // student exercise
    ...
    public static void main(String args[]) {
        Parser parser  = new Parser(new Lexer("C:\\Users\\Dream\\흔적들\\프로그래밍 언어론\\softwarestudents\\softwarestudents\\ch02-08 (Clite)\\programs\\float-fact.cpp"));
