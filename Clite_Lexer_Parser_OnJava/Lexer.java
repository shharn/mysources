...
public class Lexer {
    ...
    public Token next( ) { // Return next token
        do {
            ...
            case ' ': case '\t': case '\r': case ',': case eolnCh:
                ch = nextChar();
                break;
    ...
    private Token chkOpt(char c, Token one, Token two) {
    	...
    	ch = nextChar();
    	String str = String.valueOf(c) + ch;
    	if(str.compareTo(two.value()) == 0){
    		ch = nextChar();
    		return two;
    	}else
    		return one;
    ...
    static public void main ( String[] argv ) {
        Lexer lexer = new Lexer("C:\\Users\\Dream\\흔적들\\프로그래밍 언어론\\softwarestudents\\softwarestudents\\ch02-08 (Clite)\\programs\\nested.cpp");
